...
*/}}
{{- define "dojo-operator.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "dojo-operator.resourceName" -}}
{{- $fullname := include "dojo-operator.fullname" .context }}
{{- $suffix := .suffix }}
